...
class TagsFilter(Filter):
    ...
    def filter(self, queryset, value):
        ...
        if value:
            """Согласно документации, при наличии списка тегов, они должны
            быть разделены символом "_"."""
            tags = value.split('_')
            """Согласно документации, при нескольких указанных тегах должны
            быть выданы те рецепты, у которых есть хотя бы один из тегов."""
